...
export const TESTIMONIALS = [
    {
        id: "1",
        author: "Jane Doe",
        description: "Faced with a daunting legal challenge, I sought the expertise of Macey Law. Their team provided not only legal representation but also constant support and reassurance throughout the process. Their strategic approach played a crucial role in dealing with the complexities of my case, leading to an outcome better than I had hoped."
    },
    {
        id: "2",
        author: "John Doe",
