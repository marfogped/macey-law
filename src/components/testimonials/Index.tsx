  ...
  return (
    <section className="h-max w-full bg-[#F8F8FF] py-8">
      <div className="section-container">
        ...
        >
          ...
          <div className="flex items-center xs:flex-col sm:flex-col xxl:flex-row">
            ...
            <div className="text-lg font-semibold text-lightBlue ml-2">
              +1000 reviews
            </div>
          </div>
        </motion.div>
        ...
        {TESTIMONIALS.map((testimonial) => (
          <SwiperSlide key={testimonial.id}>
            <div className="flex flex-col p-8 relative">
              ...
              <div>
                <p className="xs:text-md sm:text-lg xl:text-2xl text-start text-balance font-lato">
      ...
      <div className="text-center mt-4 flex items-center justify-center mb-10 gap-2">
        ...
        <button className="swiper-button-next" aria-label="next-testimonial">
          {" "}
          <ChevronRight />{" "}
        </button>
      </div>
